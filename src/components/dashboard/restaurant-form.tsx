...
export function RestaurantForm() {
  ...
  if (!form) return null;
  const save = (event: React.FormEvent) => { event.preventDefault(); saveRestaurant({ ...form, updatedAt: new Date().toISOString() }); void services.notifications.notify({ title: "บันทึกข้อมูลร้านแล้ว", message: "ข้อมูลร้านถูกอัปเดตในเดโมเรียบร้อย" }); };

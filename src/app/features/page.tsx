...
const groups = [
  { icon: Store, title: "ขายหน้าร้าน", items: ["เลือกโต๊ะและค้นหาเมนู", "ส่วนลด VAT Service charge", "เงินสด QR และบัตรแบบจำลอง"] },
  ...
  { icon: Bell, title: "การแจ้งเตือน", items: ["Toast และเสียง", "Notification log", "จำลอง LINE/Discord/Telegram"] },
  { icon: ReceiptText, title: "สมาชิก", items: ["Entitlement กลาง", "Usage เทียบ Limit", "เปลี่ยนแผนแบบจำลอง"] },
];
